...
A PDF can be generated using [latexmk](https://ctan.org/pkg/latexmk), or any other LaTeX compiler. If you want to access pregenerated PDFs, please check the [Releases](https://github.com/Unisa-Notes/COS1521/releases) section on the sidebar.
...
- Various units have images related to them. These are contained in the [images](./images) folder.
...
- [listings](https://ctan.org/pkg/listings): Used to display code examples
...
- [tikz](https://ctan.org/pkg/tikz): Used for images.
  * [circuitikz](https://ctan.org/pkg/circuitikz): Used for logic circuit diagrams
  * [karnaugh-map](https://ctan.org/pkg/karnaugh-map): Used to render k-maps
