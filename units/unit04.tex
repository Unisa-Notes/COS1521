			...
			\subsection{Circuit Diagrams}
				\begin{exercise}{Circuit Diagram Exercises}
					\begin{enumerate}
						...
						\begin{center}
							% \begin{circuitikz}[]
							% 	\draw (0,0) node[nor port] (Ex1Nor){1};
							% 	\draw (0,-2) node[or port] (Ex1Or){2};
							% \end{circuitikz}
							% \begin{circuitikz}[]
							% 	\draw (4,2) node[and port] (Ex1And){4};
							% 	\draw (2,0) node[nor port] (Ex1Nor){1};
							% 	\draw (2,4) node[nand port] (Ex1Nand){3};
							% \end{circuitikz}
							% \begin{circuitikz}
							% 	\draw (4,2) node[and port, scale=2] (Ex1And){4};
							% 	\draw (Ex1And.in 2) -- ++(-1,0) node[nand port, anchor=out](Ex1Nand){3};
							% 	\draw (Ex1And.in 1) -- ++(-3,0) node[nor port, anchor=out](Ex1Nor){1};
							% \end{circuitikz}
							\begin{circuitikz}
								\draw 
								...
								% (-2,-1.5) node[or port, anchor=out, scale=0.7] (Ex1Or) {2}
								% (-2,-0.5) node[not port, anchor=out, scale=0.7] (Ex1Not) {}
